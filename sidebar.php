...
?>
	<div id="sidebar" role="complementary">
		<!-- <div id="sidebarimage"><img src="<?php bloginfo('stylesheet_directory'); ?>/images/ao-invite.png" /></div> -->
<?php if ( is_front_page() ) { ?>
			<div class="from_editor">
				...
				<p align="right"><img src="/media/images/heather-sig.jpg" /></p>
				<p align="right"><i>- Heather Vreeland</i></p>
			</div>
<?php }
