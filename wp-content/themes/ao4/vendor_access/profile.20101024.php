...
?>
				...
				<div class="TabbedPanelsContent">
					...
					<p class="vendor_desc">There are two methods of displaying video in your profile:</p>
					<p class="vendor_desc">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&bull; Embeddeding video from a 3rd party video service (e.g. Youtube, Vimeo, etc.)<br />
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&bull; Uploading your video to display inside your photo slideshow
					</p>
					<br />&nbsp;
					...
					<p class="vendor_desc">Choose this method if you already have video uploaded to a supported 3rd party video service such as Youtube, Vimeo or Viddler. Enter the URL to the video below and we will automatically embed the video in your profile below the photo slideshow. </p>
					...
					<p class="vendor_label"><label for="video_url">METHOD #2: Video Inside Your Photo Slideshow</label></p>
					<p class="vendor_desc">Choose this method if you <br />&nbsp;</p>
					...
					<p class="vendor_desc"> <i>(Coming soon...)</i></p>
				</div> 
<?php
if (checkAdmin()) {
?>
