...
?>
				<div class="TabbedPanelsContent">
					...
					<p class="vendor_txt"><input name="payment_plan" type="text" id="payment_plan" size="40" value="<?php echo $a['payment_plan']; ?>" /></p>
				
					<p class="vendor_desc">Subscription plan:</p>
					<p class="vendor_txt"><input name="subscription_plan" type="text" id="subscription_plan" size="40" value="<?php echo $a['subscription_plan']; ?>" /></p>
					...
					<p class="vendor_label">Statistics</p>
