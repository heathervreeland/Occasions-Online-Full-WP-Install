...
define ("PAGE_ADMIN",		"https://www.atlantaoccasions.com/advertisers/admin"); // admin.php
define ("PAGE_LOGIN",		"https://www.atlantaoccasions.com/advertisers/login"); // login.php
define ("PAGE_LOGOUT",		"https://www.atlantaoccasions.com/advertisers/logout"); // logout.php
define ("PAGE_HOME",		"https://www.atlantaoccasions.com/advertisers/home"); // home.php
define ("PAGE_PROFILES",	"https://www.atlantaoccasions.com/advertisers/profiles"); // profiles.php
define ("PAGE_PROFILE",		"https://www.atlantaoccasions.com/advertisers/profile"); // profile.php
define ("PAGE_SETTINGS",	"https://www.atlantaoccasions.com/advertisers/settings"); // settings.php
define ("PAGE_REGISTER",	"https://www.atlantaoccasions.com/advertisers/register"); // register.php
define ("PAGE_FORGOT",		"https://www.atlantaoccasions.com/advertisers/forgot"); // forgot.php
define ("PAGE_ACTIVATE",	"https://www.atlantaoccasions.com/advertisers/activate"); // activate.php
define ("PAGE_THANKYOU",	"https://www.atlantaoccasions.com/advertisers/thankyou"); // thankyou.php
define ("PAGE_CHECKUSER",	"https://www.atlantaoccasions.com/advertisers/checkuser"); // checkuser.php
define ("PAGE_LEADS",		"https://www.atlantaoccasions.com/advertisers/leads"); // leads.php
define ("PAGE_EVENTS",		"https://www.atlantaoccasions.com/advertisers/events"); // events.php
define ("PAGE_EVENT",		"https://www.atlantaoccasions.com/advertisers/event"); // event.php
define ("PAGE_DO",			"https://www.atlantaoccasions.com/advertisers/do"); // do.php
define ("PAGE_DOIMAGE",		"https://www.atlantaoccasions.com/advertisers/doimage"); // do_image.php
define ("PAGE_UPGRADE",		"https://www.atlantaoccasions.com/advertisers/upgrade"); // upgrade.php
define ("PAGE_UPGRADED",	"https://www.atlantaoccasions.com/advertisers/upgraded"); // upgraded.php
define ("PAGE_PAYMENT",		"https://www.atlantaoccasions.com/advertisers/payment"); // payment.php
define ("PAGE_PAYMENTMADE",	"https://www.atlantaoccasions.com/advertisers/paymentmade"); // paymentmade.php
define ("PAGE_TERMS",		"https://www.atlantaoccasions.com/advertisers/terms"); // terms.php
define ("PAGE_SHOWS",		"https://www.atlantaoccasions.com/advertisers/shows"); // shows.php
define ("PAGE_BADGES",		"https://www.atlantaoccasions.com/advertisers/badges"); // badges.php
...
function page_protect() {
	...
	/* query user level from database instead of storing in cookies */
	$result = mysql_query("select full_name, user_level, user_can_leadlist, user_can_events from {$const['TBL_USERS']} where id='$_SESSION[user_id]'");
	list($full_name, $user_level, $user_can_leadlist, $user_can_events) = mysql_fetch_row($result);
...
function logout($do_redirect = TRUE)
{
	...
	if(isset($_SESSION['user_id']) || isset($_COOKIE['user_id'])) {
		mysql_query("update {$const['TBL_USERS']} set `ckey`= '', `ctime`= '' where `id`='$_SESSION[user_id]' OR  `id` = '$cookieUserID'") or die(mysql_error());
	}			
