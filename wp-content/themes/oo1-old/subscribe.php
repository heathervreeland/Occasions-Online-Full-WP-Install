...
<div class="subscription-block">
	<img src="/media/images/issue-summer-2011.jpg" />
...
<div class="backissue-block1 clearme"><div class="backissue-block2">
	...
	<div class="priceline">
		<div class="subscription-price"><input name="sf2009" type="text" id="sf2009" size="2" class="subscription-text" value="<?php echo $a_cart['sf2009']; ?>" /> $5.99 EACH</div>
		<div class="subscription-price"><input name="sf2009b" type="text" id="sf2009b" size="2" class="subscription-text" value="<?php echo $a_cart['sf2009b']; ?>" /> $50.00 / BOX OF 10</div>
	</div>
...
<div class="backissue-block1 clearme"><div class="backissue-block2">
	...
	<div class="priceline">
		<div class="subscription-price"><input name="ws2010" type="text" id="ws2010" size="2" class="subscription-text" value="<?php echo $a_cart['ws2010']; ?>" /> $5.99 EACH</div>
		<div class="subscription-price"><input name="ws2010b" type="text" id="ws2010b" size="2" class="subscription-text" value="<?php echo $a_cart['ws2010b']; ?>" /> $50.00 / BOX OF 10</div>
	</div>
</div></div>
...
<div class="backissue-block1 clearme"><div class="backissue-block2">
	<img src="/media/images/issue-winter-2011.jpg" />
...
<div class="backissue-block1 clearme"><div class="backissue-block2">
	<img src="/media/images/issue-summer-2011.jpg" />
	<div><span class="head3 oo-color-brown">Summer 2011 (current issue)</span></div>
	<div class="head5 normalcase">REGION: Atlanta</div>
	<p></p>
	<div class="priceline">
		<div class="subscription-price"><input name="s2011" type="text" id="s2011" size="2" class="subscription-text" value="<?php echo $a_cart['s2011']; ?>" /> $5.99 EACH</div>
		<div class="subscription-price"><input name="s2011b" type="text" id="s2011b" size="2" class="subscription-text" value="<?php echo $a_cart['s2011b']; ?>" /> $50.00 / BOX OF 10</div>
	</div>
</div></div>
