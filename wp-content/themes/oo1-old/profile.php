...
elseif ($cmd == 'emailben') {
	$subject = 'Google Test for Flags';
	$headers = 'From: "Heather Vreeland" <heather@OccasionsOnline.com>' . "\r\n" .
		'Reply-To: "Occasions Magazine" <clientcontact@OccasionsOnline.com>' . "\r\n" .
		'X-Mailer: AO5/PHP/' . phpversion();

	$msg = 'This email was sent from the Occasions Magazine profile testing branch.'. "\r\n";
