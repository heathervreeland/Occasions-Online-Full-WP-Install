...
FROM  ao_logs 
JOIN wp_pod_tbl_vendor_profiles ON wp_pod_tbl_vendor_profiles.id = ao_logs.item_id
WHERE wp_pod_tbl_vendor_profiles.id = $pid AND action = 'profile_view' AND stamp > DATE_ADD(NOW(), INTERVAL -13 MONTH)
GROUP BY Y, M, wp_pod_tbl_vendor_profiles.name
ORDER BY Y, M";
...
$sql_click_seo = "SELECT YEAR(stamp) AS Y, MONTH(stamp) AS M, MONTHNAME(stamp) AS MN, wp_pod_tbl_vendor_profiles.id, wp_pod_tbl_vendor_profiles.name, slug, COUNT(*) AS C
FROM  ao_logs_bots 
JOIN wp_pod_tbl_vendor_profiles ON wp_pod_tbl_vendor_profiles.id = ao_logs_bots.item_id
WHERE wp_pod_tbl_vendor_profiles.id = $pid AND stamp > DATE_ADD(NOW(), INTERVAL -13 MONTH)
GROUP BY Y, M, wp_pod_tbl_vendor_profiles.name
ORDER BY Y, M";

$chart = new VerticalBarChart(570, 300);
$dataSet = new XYDataSet();
$chart->setTitle("Overall Activity for " . $a['name']);
...
$chart = new VerticalBarChart(570, 300);
$dataSet = new XYDataSet();
$chart->setTitle("PROFILE VIEWS for " . $a['name']);
...
$chart = new VerticalBarChart(570, 300);
$dataSet = new XYDataSet();
$chart->setTitle("AD BANNER clicks for " . $a['name']);
...
$chart = new VerticalBarChart(570, 300);
$dataSet = new XYDataSet();
$chart->setTitle("WEBSITE click-thrus for " . $a['name']);
...
$chart = new VerticalBarChart(570, 300);
$dataSet = new XYDataSet();
$chart->setTitle("BLOG click-thrus for " . $a['name']);
...
$chart = new VerticalBarChart(570, 300);
$dataSet = new XYDataSet();
$chart->setTitle("FACEBOOK click-thrus for " . $a['name']);
...
$chart = new VerticalBarChart(570, 300);
$dataSet = new XYDataSet();
$chart->setTitle("TWITTER click-thrus for " . $a['name']);
...
$chart = new VerticalBarChart(570, 300);
$dataSet = new XYDataSet();
$chart->setTitle("LINKEDIN click-thrus for " . $a['name']);
