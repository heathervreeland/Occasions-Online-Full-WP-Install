...
if(empty($err)) {
	...
	$profile_data['subscription_plan'] = 'NA';
...
";
	...
	mail($usr_email, $subject, $message, $headers, AO_EMAIL_FLAGS);
	mail(AO_ADMIN_EMAIL, $subject_admin, $message_admin, $headers, AO_EMAIL_FLAGS);
	mail(AO_SALES_EMAIL, $subject_admin, $message_admin, $headers, AO_EMAIL_FLAGS);
	mail(AO_OFFICE_EMAIL, $subject_admin, $message_admin, $headers, AO_EMAIL_FLAGS);
	mail(AO_TECH_EMAIL, $subject_admin, $message_admin, $headers, AO_EMAIL_FLAGS);
