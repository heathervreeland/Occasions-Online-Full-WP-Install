...
/* Template Name: Vendor Profile 4 */
...
if ($_POST['review_submitted'] == "1") {
	...
	$txt_answer = $_POST['txt_answer'];
	$rand3 = $_POST['rand3'];
	$rand4 = $_POST['rand4'];
	
	if ( ( (int)$rand3 + (int)$rand4 ) / 2 == (int)$txt_answer ) {
...
<?php	
	...
	$review_form = <<<HEREDOC
	<p>Please fill out ALL the fields below. Your email is required for verification purposes only and will not be published.</p>
	<form action="/profile/$slug" method="post">
		<div class="pro_reviewrow">
			<div class="pro_reviewlabel"><label for="txt_name">Name:</label></div>
			<div class="pro_reviewtxt"><input name="txt_name" type="text" size="50" id="txt_name" value="" /></div>
		</div>
		<div class="pro_reviewrow">
			<div class="pro_reviewlabel"><label for="txt_email">Email:</label></div>
			<div class="pro_reviewtxt"><input name="txt_email" type="text" size="50" id="txt_email" value="" /></div>
		</div>
		<div class="pro_reviewrow">
			<div class="pro_reviewlabel"><label for="txt_comments">Your Review:</label></div>
			<div class="pro_reviewtxt"><textarea name="txt_comments" rows="2" cols="20" id="txt_comments"></textarea></div>
		</div>
		<div class="pro_reviewrow">
		...
		<div class="pro_reviewrow">
			<div class="pro_reviewlabel"><label for="txt_answer">What is $rand1 + $rand2?</label></div>
			<div class="pro_reviewtxt"><input name="txt_answer" type="text" size="50" id="txt_answer" value="" /></div>
		</div>
		<div class="pro_reviewrow">
