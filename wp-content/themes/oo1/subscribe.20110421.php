...
?>
	<tr>
		...
		<td class="sub-col3">Sales Tax</td>
...
mail(AO_ADMIN_EMAIL, $subject, $message, $headers);
mail(AO_OFFICE_EMAIL, $subject, $message, $headers);
mail(AO_TECH_EMAIL, $subject, $message, $headers);
...
<div class="backissue-block1 clearme"><div class="backissue-block2">
	<img src="/media/images/issue-winter-2011.jpg" />
	<div><span class="head3 oo-color-brown">Winter 2011 (current issue)</span></div>
	<div class="head5 normalcase">REGION: Atlanta</div>
