...
if($_POST['doSave'] == 'Save') {
	...
	$data['force_logout'] = iif($_POST['force_logout'] == '1', '1', '0');
	...
	if (checkAdmin()) {
		...
		$sql .= ", force_logout = '$data[force_logout]'";
	}
...
?>
		...
		<div class="pro_contactrow">
			<div class="pro_contactlabel" id="ven_label"><label for="force_logout">&nbsp;</label></div>
			<div class="pro_contacttxt" id="ven_txt"><input class="vendor_checkbox" name="force_logout" type="checkbox" id="force_logout" value="1" <?php echo iif($row_settings['force_logout'] == '1', 'checked', ''); ?> /> <label for="force_logout">Force logout at next activity. (admin only)</label></div>
		</div>
<?php 	
}
?>
