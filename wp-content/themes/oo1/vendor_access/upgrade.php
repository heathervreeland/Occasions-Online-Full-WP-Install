...
<p>Your business profile is now live on OccasionsOnline.com. To attract readers to your profile and enhance your listing, log on using the ID and Password you created to add photos, a detailed description of your services, contact information and link to your website, blog and social networks.</p>
<p><b>USER REVIEWS</b></p>
<p>User reviews are the best third party testimonial your business has. We encourage you to contact your past customers and have them rate and review you on OccasionsOnline.com. Positive reviews help new customers choose you over the competition! A link to your business profile on your website that reads &ldquo;Rate and Review us on OccasionsOnline.com&rdquo; helps increase those reviews.</p>
<p><b>LINK TO OCCASIONSONLINE.COM</b></p>
<p>Now that your business is featured in on OccasionsOnline.com you&rsquo;ll want to tell all of your clients. Place a link to your business profile on OccasionsOnline.com on your website. You can use the advertiser badges available here.</p>
<p><b>NETWORKING</b></p>
...
<p><b>USER LEADS</b></p>
<p>As an advertiser of Occasions Magazine you have access to readers who have registered on the OccasionsOnline.com site. We don&rsquo;t require visitors to register before viewing ads, so the size of the lead list is in no way relative to the amount of visitors to the site, it&rsquo;s just a list of those people who actually want to be contacted by vendors. Don&rsquo;t miss out... get in touch with these people!<br />
...
<p>Occasions Magazine (OccasionsOnline.com) is the one and only media of if it&rsquo;s kind in Metro Atlanta. And to boot, our print edition reaches thousands of Metro Atlanta brides and families planning events. To receive a copy of our print media kit and schedule a time to discuss enhancing your coverage in the next issue of Occasions Magazine, contact us at <a href="mailto:info@occasionsonline.com">info@occasionsonline.com</a>.</p>
<p><b>CUSTOMER SUPPORT</b></p>
<p>We&rsquo;re here for you when you need us. For questions regarding your profile or any other comments and concerns, please email <a href="mailto:support@occasionsonline.com">support@occasionsonline.com</a> and a member of our staff will respond within 24 hours.</p>
...
mail(AO_SALES_EMAIL, $subject_admin, $message_admin, $headers_admin, AO_EMAIL_FLAGS);
mail(AO_OFFICE_EMAIL, $subject_admin, $message_admin, $headers_admin, AO_EMAIL_FLAGS);
...
?>
	...
	<div><img src="/media/images/cvv.jpg" /></div>
