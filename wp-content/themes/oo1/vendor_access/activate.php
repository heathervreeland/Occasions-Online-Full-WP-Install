...
<p>Month-to-Month $79 Per Month<br />
Annual Commitments $59 paid each month or $708 in advance&nbsp;</p>
...
mail($user_email, "Occasions Magazine: Welcome", $email_message, $headers, AO_EMAIL_FLAGS);
mail(AO_TECH_EMAIL, "Occasions Magazine: Welcome", $email_message, $headers, AO_EMAIL_FLAGS);
