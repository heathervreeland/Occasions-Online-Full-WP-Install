...
<?php
						...
						if( $total_cats > 0 ) {
							while ( $categories->fetchRecord() ) {
								...
								echo '<div class="guide-cat"><a href="/atlanta/', $cat_slug, '">', $cat_name, '</a></div>';
								$cols++;
								if ($cols == 5) {
						...
						echo '<div class="guide-featcatcolumn" onclick="window.location.href=\'/atlanta/venues\'"><a href="/atlanta/venues"><div class="guide-catimage"><img src="', bloginfo('stylesheet_directory'), '/images/cat-venues.jpg" /></div><div class="guide-catname">Venues</div></a></div>';
						echo '<div class="guide-featcatcolumn" onclick="window.location.href=\'/atlanta/photographers\'"><a href="/atlanta/photographers"><div class="guide-catimage"><img src="', bloginfo('stylesheet_directory'), '/images/cat-photographers.jpg" /></div><div class="guide-catname">Photographers</div></a></div>';
						echo '<div class="guide-featcatcolumn" onclick="window.location.href=\'/atlanta/caterers\'"><a href="/atlanta/caterers"><div class="guide-catimage"><img src="', bloginfo('stylesheet_directory'), '/images/cat-caterers.jpg" /></div><div class="guide-catname">Caterers</div></a></div>';
						echo '<div class="guide-featcatcolumn" onclick="window.location.href=\'/atlanta/rental-companies\'"><a href="/atlanta/rental-companies"><div class="guide-catimage"><img src="', bloginfo('stylesheet_directory'), '/images/cat-rentals.jpg" /></div><div class="guide-catname">Rentals</div></a></div>';
						echo '<div class="guide-featcatcolumn" onclick="window.location.href=\'/atlanta/flowers\'"><a href="/atlanta/flowers"><div class="guide-catimage"><img src="', bloginfo('stylesheet_directory'), '/images/cat-decor.jpg" /></div><div class="guide-catname">Flowers</div></a></div>';
						echo '<div class="clear"></a>';
...
<?php
						...
						$cols = 0;
						echo '<div class="guide-type"><a href="/atlanta/venues">all venues</a></div>';
						$cols++;
						if( $total_types > 0 ) {
							while ( $types->fetchRecord() ) {
								$type_name		= $types->get_field('name');
								$type_slug		= $types->get_field('slug');
								echo '<div class="guide-type"><a href="/atlanta/venues/', $type_slug, '">', $type_name, '</a></div>';
								$cols++;
								if ($cols == 5) {
						...
						$pops_sql = "SELECT wp_pod_tbl_vendor_profiles.id, wp_pod_tbl_vendor_profiles.name, slug, COUNT( * ) " .
									"FROM  ao_logs  " .
									"JOIN wp_pod_tbl_vendor_profiles ON wp_pod_tbl_vendor_profiles.id = ao_logs.item_id " .
									"WHERE action IN ('profile_view','click_ad','click_web','click_blog','click_facebook','click_twitter','click_linkedin') ".
									"  AND profile_type = 'Platinum' " .
									"  AND stamp > DATE_ADD(NOW(), INTERVAL -60 DAY) " .
									"GROUP BY wp_pod_tbl_vendor_profiles.name " .
