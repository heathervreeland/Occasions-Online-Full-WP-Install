...
<ul><li><a href="/guide/venues">Venues</a></li><li><a href="/guide/dining">Rehearsal Dinner & Private Dining</a></li>
<?php
		$categories = new Pod('categories');
		$categories->findRecords( '', 0, '', 'SELECT name, slug, description FROM wp_pod_tbl_categories WHERE parentid IN (3) AND hide <> 1 ORDER BY name');
