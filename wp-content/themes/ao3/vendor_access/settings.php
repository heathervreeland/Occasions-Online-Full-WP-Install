...
if($_POST['doSave'] == 'Save') {
	...
	mysql_query("UPDATE {$const['TBL_USERS']} SET
...
/******************************* END ********************************/	  
?>
<p>Here you can make changes to your account settings. You will not be able to change your email which has been already registered.</p>
<?php
...
?>
		...
		<div class="pro_contactrow">
			<div class="pro_contactlabel" id="ven_label"><label for="usr_email">Your Email</label></div>
			<div class="pro_contacttxt" id="ven_txt"><input name="user_email" type="text" id="usr_email" class="required" value="<? echo $row_settings['user_email']; ?>" disabled /></div>
		</div>
